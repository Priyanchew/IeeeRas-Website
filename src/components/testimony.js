...
export default function Testimonies() {
    return (
        <section id="projects" className="w-full py-8 md:py-16 lg:py-20">
            <div className="container px-4 md:px-6">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-8">Testimonies</h2>
